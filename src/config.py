...
download_repos_link_dir = os.path.join(root_dir, "all_repo_download_link.txt")
working_ticket_ids_dir = os.path.join(root_dir, "target_ticket_ids.txt")
finished_repo_list = list(os.listdir(source_code_embedding_collection_dir))
ticket_info_dataset_dir = os.path.join(root_dir, "combined_dataset.csv")
ticket_repo_dir = os.path.join(root_dir, "ticket_repo.csv")
black_list_file = []
is_building = True
is_evaluate = True
is_download = True
